...
export function AnimatedShinyTextDemo({text}:{text: string}) {
  return (
    <div className="z-10 flex  items-center justify-center">
      ...
      >
        <AnimatedShinyText className="inline-flex space-x-3 items-center justify-center px-4 py-1 transition ease-out hover:text-neutral-600 hover:duration-300 hover:dark:text-neutral-400">
        <Image
