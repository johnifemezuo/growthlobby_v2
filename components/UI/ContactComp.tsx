...
const ContactComp = () => {
  return (
    <div className="flex min-w-[300px] lg:w-auto bg-white border border-zinc-200 p-1  rounded-lg flex-row items-center justify-between lg:justify-center gap-2 mt-8">
      <Link
        href="/book"
