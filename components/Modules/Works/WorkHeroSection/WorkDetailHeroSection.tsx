...
const WorkDetailHeroSection = ({
  ...
  return (
    <div className="h-auto w-full relative bg-white py-20 lg:py-20  overflow-hidden">
      ...
      <PageContainer>
        <div className="flex flex-col justify-center  h-full  px-5 lg:px-0">
          <div className=" mb-4 lg:mb-8 lg:flex lg:space-x-12 py-8 lg:pt-12 lg:mt-12  w-full justify-between space-y-4 lg:space-y-0 lg:px-0">
            <h1 className="text-4xl max-w-2xl  mx-auto font-bold lg:text-4xl xl:text-5xl ">
              {title}
            </h1>
            ...
            <div className="text-left max-w-lg space-y-5">
              ...
              {livesite ? (
                <Link
                  target="_blank"
                  className="inline-block rounded-full bg-black text-white px-6 py-4"
                  href={livesite}
                >
                  Visit site
                </Link>
      ...
      />
          ...
          <div className="flex w-full lg:w-auto bg-white border border-zinc-200 p-1.5 lg:p-3  rounded-lg flex-row items-center justify-between lg:justify-center gap-4 ">
            <Image src={image} alt={title} width={1200} height={100} className="lg:h-full object-cover w-full" />
          </div>
        </div>
      </PageContainer>
    </div>
