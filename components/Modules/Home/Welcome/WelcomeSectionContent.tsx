...
const WelcomeSectionContent = () => {
  return (
    <div className="text-[#808080] font-wixMadefor md:text-[28px] text-[20px] leading-normal font-semibold md:w-[40%] flex flex-col md:gap-6 gap-4 ">
          ...
          <TextReveal>We don’t just create; we craft powerful brands, stunning websites, and cutting-edge apps that resonate, bridging the gap between vision and reality.</TextReveal>
